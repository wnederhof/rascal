...
public abstract class OptionalSugarType extends AbstractAST {
  public OptionalSugarType(ISourceLocation src, IConstructor node) {
  ...
  static public class Default extends OptionalSugarType {
    ...
    public <T> T accept(IASTVisitor<T> visitor) {
      return visitor.visitOptionalSugarTypeDefault(this);
    }
  ...
  static public class None extends OptionalSugarType {
    ...
    @Override
    public <T> T accept(IASTVisitor<T> visitor) {
      return visitor.visitOptionalSugarTypeNone(this);
    }
