...
public abstract class StringMiddle extends AbstractAST {
  ...
  static public class Interpolated extends StringMiddle {
    ...
    @Override
    public int hashCode() {
      return 73 + 991 * mid.hashCode() + 911 * expression.hashCode() + 379 * tail.hashCode() ; 
    } 
  ...
  static public class Template extends StringMiddle {
    ...
    @Override
    public int hashCode() {
      return 83 + 71 * mid.hashCode() + 683 * template.hashCode() + 839 * tail.hashCode() ; 
    } 
