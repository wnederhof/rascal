...
public abstract class StringMiddle extends AbstractAST {
  ...
  static public class Interpolated extends StringMiddle {
    ...
    @Override
    public int hashCode() {
      return 281 + 409 * mid.hashCode() + 97 * expression.hashCode() + 607 * tail.hashCode() ; 
    } 
  ...
  static public class Template extends StringMiddle {
    ...
    @Override
    public int hashCode() {
      return 757 + 347 * mid.hashCode() + 73 * template.hashCode() + 181 * tail.hashCode() ; 
    } 
