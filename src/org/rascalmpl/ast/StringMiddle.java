...
public abstract class StringMiddle extends AbstractAST {
  ...
  static public class Interpolated extends StringMiddle {
    ...
    @Override
    public int hashCode() {
      return 409 + 97 * mid.hashCode() + 607 * expression.hashCode() + 547 * tail.hashCode() ; 
    } 
  ...
  static public class Template extends StringMiddle {
    ...
    @Override
    public int hashCode() {
      return 347 + 73 * mid.hashCode() + 181 * template.hashCode() + 499 * tail.hashCode() ; 
    } 
