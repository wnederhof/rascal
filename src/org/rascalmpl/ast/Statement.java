...
public abstract class Statement extends AbstractAST {
  ...
  static public class Assert extends Statement {
    ...
    @Override
    public int hashCode() {
      return 113 + 607 * expression.hashCode() ; 
    } 
  ...
  static public class AssertWithMessage extends Statement {
    ...
    @Override
    public int hashCode() {
      return 151 + 409 * expression.hashCode() + 691 * message.hashCode() ; 
    } 
  ...
  static public class Assignment extends Statement {
    ...
    @Override
    public int hashCode() {
      return 691 + 73 * assignable.hashCode() + 457 * operator.hashCode() + 719 * statement.hashCode() ; 
    } 
  ...
  static public class Break extends Statement {
    ...
    @Override
    public int hashCode() {
      return 461 + 929 * target.hashCode() ; 
    } 
  ...
  static public class Continue extends Statement {
    ...
    @Override
    public int hashCode() {
      return 199 + 569 * target.hashCode() ; 
    } 
  ...
  static public class DoWhile extends Statement {
    ...
    @Override
    public int hashCode() {
      return 149 + 569 * label.hashCode() + 617 * body.hashCode() + 389 * condition.hashCode() ; 
    } 
  ...
  static public class Expression extends Statement {
    ...
    @Override
    public int hashCode() {
      return 757 + 439 * expression.hashCode() ; 
    } 
  ...
  static public class Fail extends Statement {
    ...
    @Override
    public int hashCode() {
      return 239 + 641 * target.hashCode() ; 
    } 
  ...
  static public class For extends Statement {
    ...
    @Override
    public int hashCode() {
      return 269 + 389 * label.hashCode() + 367 * generators.hashCode() + 643 * body.hashCode() ; 
    } 
  ...
  static public class FunctionDeclaration extends Statement {
    ...
    @Override
    public int hashCode() {
      return 619 + 631 * functionDeclaration.hashCode() ; 
    } 
  ...
  static public class GlobalDirective extends Statement {
    ...
    @Override
    public int hashCode() {
      return 151 + 593 * type.hashCode() + 109 * names.hashCode() ; 
    } 
  ...
  static public class IfThen extends Statement {
    ...
    @Override
    public int hashCode() {
      return 53 + 839 * label.hashCode() + 389 * conditions.hashCode() + 229 * thenStatement.hashCode() ; 
    } 
  ...
  static public class IfThenElse extends Statement {
    ...
    @Override
    public int hashCode() {
      return 157 + 283 * label.hashCode() + 947 * conditions.hashCode() + 541 * thenStatement.hashCode() + 103 * elseStatement.hashCode() ; 
    } 
  ...
  static public class Insert extends Statement {
    ...
    @Override
    public int hashCode() {
      return 619 + 421 * dataTarget.hashCode() + 541 * statement.hashCode() ; 
    } 
  ...
  static public class NonEmptyBlock extends Statement {
    ...
    @Override
    public int hashCode() {
      return 509 + 941 * label.hashCode() + 653 * statements.hashCode() ; 
    } 
  ...
  static public class Return extends Statement {
    ...
    @Override
    public int hashCode() {
      return 13 + 787 * statement.hashCode() ; 
    } 
  ...
  static public class Solve extends Statement {
    ...
    @Override
    public int hashCode() {
      return 37 + 131 * variables.hashCode() + 331 * bound.hashCode() + 521 * body.hashCode() ; 
    } 
  ...
  static public class Switch extends Statement {
    ...
    @Override
    public int hashCode() {
      return 839 + 191 * label.hashCode() + 599 * expression.hashCode() + 109 * cases.hashCode() ; 
    } 
  ...
  static public class Throw extends Statement {
    ...
    @Override
    public int hashCode() {
      return 977 + 2 * statement.hashCode() ; 
    } 
  ...
  static public class Try extends Statement {
    ...
    @Override
    public int hashCode() {
      return 947 + 281 * body.hashCode() + 409 * handlers.hashCode() ; 
    } 
  ...
  static public class TryFinally extends Statement {
    ...
    @Override
    public int hashCode() {
      return 97 + 607 * body.hashCode() + 547 * handlers.hashCode() + 283 * finallyBody.hashCode() ; 
    } 
  ...
  static public class VariableDeclaration extends Statement {
    ...
    @Override
    public int hashCode() {
      return 757 + 347 * declaration.hashCode() ; 
    } 
  ...
  static public class Visit extends Statement {
    ...
    @Override
    public int hashCode() {
      return 73 + 181 * label.hashCode() + 499 * visit.hashCode() ; 
    } 
  ...
  static public class While extends Statement {
    ...
    @Override
    public int hashCode() {
      return 227 + 389 * label.hashCode() + 479 * conditions.hashCode() + 103 * body.hashCode() ; 
    } 
