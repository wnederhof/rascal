...
public abstract class StringTail extends AbstractAST {
  ...
  static public class MidInterpolated extends StringTail {
    ...
    @Override
    public int hashCode() {
      return 227 + 389 * mid.hashCode() + 479 * expression.hashCode() + 103 * tail.hashCode() ; 
    } 
  ...
  static public class MidTemplate extends StringTail {
    ...
    @Override
    public int hashCode() {
      return 859 + 163 * mid.hashCode() + 739 * template.hashCode() + 821 * tail.hashCode() ; 
    } 
