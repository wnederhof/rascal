...
public abstract class StringTail extends AbstractAST {
  ...
  static public class MidInterpolated extends StringTail {
    ...
    @Override
    public int hashCode() {
      return 193 + 199 * mid.hashCode() + 389 * expression.hashCode() + 281 * tail.hashCode() ; 
    } 
  ...
  static public class MidTemplate extends StringTail {
    ...
    @Override
    public int hashCode() {
      return 389 + 683 * mid.hashCode() + 577 * template.hashCode() + 653 * tail.hashCode() ; 
    } 
