...
public abstract class Header extends AbstractAST {
  ...
  static public class Default extends Header {
    ...
    @Override
    public int hashCode() {
      return 773 + 277 * tags.hashCode() + 239 * name.hashCode() + 151 * imports.hashCode() ; 
    } 
  ...
  static public class Parameters extends Header {
    ...
    @Override
    public int hashCode() {
      return 397 + 137 * tags.hashCode() + 811 * name.hashCode() + 709 * params.hashCode() + 167 * imports.hashCode() ; 
    } 
