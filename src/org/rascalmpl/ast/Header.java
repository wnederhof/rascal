...
public abstract class Header extends AbstractAST {
  ...
  static public class Default extends Header {
    ...
    @Override
    public int hashCode() {
      return 331 + 17 * tags.hashCode() + 401 * name.hashCode() + 313 * imports.hashCode() ; 
    } 
  ...
  static public class Parameters extends Header {
    ...
    @Override
    public int hashCode() {
      return 449 + 463 * tags.hashCode() + 971 * name.hashCode() + 179 * params.hashCode() + 229 * imports.hashCode() ; 
    } 
