...
public abstract class Header extends AbstractAST {
  ...
  static public class Default extends Header {
    ...
    @Override
    public int hashCode() {
      return 719 + 773 * tags.hashCode() + 277 * name.hashCode() + 239 * imports.hashCode() ; 
    } 
  ...
  static public class Parameters extends Header {
    ...
    @Override
    public int hashCode() {
      return 151 + 397 * tags.hashCode() + 137 * name.hashCode() + 811 * params.hashCode() + 709 * imports.hashCode() ; 
    } 
