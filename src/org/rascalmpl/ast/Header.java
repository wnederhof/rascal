...
public abstract class Header extends AbstractAST {
  ...
  static public class Default extends Header {
    ...
    @Override
    public int hashCode() {
      return 397 + 137 * tags.hashCode() + 811 * name.hashCode() + 709 * imports.hashCode() ; 
    } 
  ...
  static public class Parameters extends Header {
    ...
    @Override
    public int hashCode() {
      return 167 + 53 * tags.hashCode() + 463 * name.hashCode() + 127 * params.hashCode() + 67 * imports.hashCode() ; 
    } 
