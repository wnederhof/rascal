...
public abstract class Header extends AbstractAST {
  ...
  static public class Default extends Header {
    ...
    @Override
    public int hashCode() {
      return 401 + 313 * tags.hashCode() + 449 * name.hashCode() + 463 * imports.hashCode() ; 
    } 
  ...
  static public class Parameters extends Header {
    ...
    @Override
    public int hashCode() {
      return 971 + 179 * tags.hashCode() + 229 * name.hashCode() + 823 * params.hashCode() + 43 * imports.hashCode() ; 
    } 
