...
public abstract class Header extends AbstractAST {
  ...
  static public class Default extends Header {
    ...
    @Override
    public int hashCode() {
      return 997 + 367 * tags.hashCode() + 401 * name.hashCode() + 139 * imports.hashCode() ; 
    } 
  ...
  static public class Parameters extends Header {
    ...
    @Override
    public int hashCode() {
      return 937 + 521 * tags.hashCode() + 719 * name.hashCode() + 773 * params.hashCode() + 277 * imports.hashCode() ; 
    } 
