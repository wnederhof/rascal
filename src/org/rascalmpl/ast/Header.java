...
public abstract class Header extends AbstractAST {
  ...
  static public class Default extends Header {
    ...
    @Override
    public int hashCode() {
      return 709 + 167 * tags.hashCode() + 53 * name.hashCode() + 463 * imports.hashCode() ; 
    } 
  ...
  static public class Parameters extends Header {
    ...
    @Override
    public int hashCode() {
      return 127 + 67 * tags.hashCode() + 643 * name.hashCode() + 229 * params.hashCode() + 271 * imports.hashCode() ; 
    } 
