...
public abstract class Header extends AbstractAST {
  ...
  static public class Default extends Header {
    ...
    @Override
    public int hashCode() {
      return 313 + 449 * tags.hashCode() + 463 * name.hashCode() + 971 * imports.hashCode() ; 
    } 
  ...
  static public class Parameters extends Header {
    ...
    @Override
    public int hashCode() {
      return 179 + 229 * tags.hashCode() + 823 * name.hashCode() + 43 * params.hashCode() + 733 * imports.hashCode() ; 
    } 
