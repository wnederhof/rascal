...
public abstract class SyntaxDefinition extends AbstractAST {
  ...
  static public class Keyword extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 29 + 947 * defined.hashCode() + 883 * production.hashCode() ; 
    } 
  ...
  static public class Language extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 743 + 313 * start.hashCode() + 607 * defined.hashCode() + 727 * production.hashCode() ; 
    } 
  ...
  static public class Layout extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 883 + 617 * vis.hashCode() + 233 * defined.hashCode() + 263 * production.hashCode() ; 
    } 
  ...
  static public class Lexical extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 163 + 683 * defined.hashCode() + 661 * production.hashCode() ; 
    } 
