...
public abstract class SyntaxDefinition extends AbstractAST {
  ...
  static public class Keyword extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 191 + 977 * defined.hashCode() + 173 * production.hashCode() ; 
    } 
  ...
  static public class Language extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 541 + 491 * start.hashCode() + 331 * defined.hashCode() + 167 * production.hashCode() ; 
    } 
  ...
  static public class Layout extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 809 + 109 * vis.hashCode() + 373 * defined.hashCode() + 449 * production.hashCode() ; 
    } 
  ...
  static public class Lexical extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 571 + 467 * defined.hashCode() + 691 * production.hashCode() ; 
    } 
