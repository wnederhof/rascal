...
public abstract class SyntaxDefinition extends AbstractAST {
  ...
  static public class Keyword extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 839 + 743 * defined.hashCode() + 751 * production.hashCode() ; 
    } 
  ...
  static public class Language extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 241 + 911 * start.hashCode() + 827 * defined.hashCode() + 29 * production.hashCode() ; 
    } 
  ...
  static public class Layout extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 947 + 883 * vis.hashCode() + 743 * defined.hashCode() + 313 * production.hashCode() ; 
    } 
