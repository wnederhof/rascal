...
public abstract class SyntaxDefinition extends AbstractAST {
  ...
  static public class Language extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 563 + 149 * start.hashCode() + 431 * defined.hashCode() + 67 * production.hashCode() ; 
    } 
  ...
  static public class Layout extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 19 + 181 * vis.hashCode() + 599 * defined.hashCode() + 101 * production.hashCode() ; 
    } 
  ...
  static public class Lexical extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 421 + 277 * defined.hashCode() + 487 * production.hashCode() ; 
    } 
