...
public abstract class SyntaxDefinition extends AbstractAST {
  ...
  static public class Keyword extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 491 + 331 * defined.hashCode() + 167 * production.hashCode() ; 
    } 
  ...
  static public class Language extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 809 + 109 * start.hashCode() + 373 * defined.hashCode() + 449 * production.hashCode() ; 
    } 
  ...
  static public class Layout extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 571 + 467 * vis.hashCode() + 691 * defined.hashCode() + 701 * production.hashCode() ; 
    } 
  ...
  static public class Lexical extends SyntaxDefinition {
    ...
    @Override
    public int hashCode() {
      return 19 + 137 * defined.hashCode() + 907 * production.hashCode() ; 
    } 
